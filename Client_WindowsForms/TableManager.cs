    ...
    internal class TableManager
    {
        ...
        private TableFiller[] GetTableFillers(DataGridView[] tables)
        {
            ...
            tablesFillers[1] = () =>
            {
                ...
                if (!TryParseCells(cells, out double[] parameters) || parameters[1] <= 0 || parameters[0] <= 0)
                {
                    tables[1][2, 0].Value = 0;
                    tables[1][3, 0].Value = 0;
                    return;
                }
            ...
            tablesFillers[4] = () =>
            {
                DataGridViewCell[] cells = { tables[4][0, 0], tables[4][1, 0], tables[4][2, 0], tables[4][3, 0] };
                if (!TryParseCells(cells, out int[] parameters) || parameters[0] <= 0 || parameters[1] <= 0 || parameters[2] <= 0 || parameters[3] <= 0)
                {
            ...
            tablesFillers[6] = () =>
            {
                ...
                if (!TryParseCells(cells, out int[] parameters) || parameters[0] <= 0 || parameters[1] <= 0)
                {
            ...
            tablesFillers[7] = () =>
            {
                for (var i = 0; i < tables[7].Rows.Count; i++)
                {
                    ...
                    if (!TryParseCells(cells, out int[] parameters) || parameters[1] <= 0 || parameters[0] <= 0)
                    {
